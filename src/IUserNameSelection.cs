...
/// <summary>
/// Provides a mechanism to choose which username to use in the event that multiple usernames exist for a given URI in the Keychain.
/// </summary>
public interface IUserNameSelection
{
    /// <summary>
    /// The maximum number of usernames retrieved from the Keychain for a given URI.
    /// </summary>
    ...
    /// <summary>
    /// Select a username among the possible ones for the given <paramref name="uri"/>.
    /// </summary>
    ...
    /// <param name="userNames">The collection of available usernames in the Keychain to choose from.</param>
